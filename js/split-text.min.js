...
!function(t) {
    ...
    var e = t.GreenSockGlobals || t,
        ...
        L = function(t) {
            var e,
                ...
                r = n.length;
            for (e = 0; r > e; e++)
                i = n[e], i._isSplit ? L(i) : (e && 3 === i.previousSibling.nodeType ? i.previousSibling.nodeValue += 3 === i.nodeType ? i.nodeValue : i.firstChild.nodeValue : 3 !== i.nodeType && t.insertBefore(i.firstChild, i), t.removeChild(i))
        },
        O = function(t, e, i, n, r, o, s) {
            var a,
                ...
                Y = -1 !== (F || "").indexOf("++"),
                Q = [];
            for (I && 1 === t.children.length && t.children[0]._isSplit && (t = t.children[0]), Y && (F = F.split("++").join("")), h = t.getElementsByTagName("*"), l = h.length, g = [], a = 0; l > a; a++)
                g[a] = h[a];
            if (I || j)
                for (a = 0; l > a; a++)
                    f = g[a], p = f.parentNode === t, (p || j || B && !X) && (y = f.offsetTop, I && p && Math.abs(y - x) > T && "BR" !== f.nodeName && (_ = [], I.push(_), x = y), j && (f._x = f.offsetLeft, f._y = y, f._w = f.offsetWidth, f._h = f.offsetHeight), I && ((f._isSplit && p || !B && p || X && p || !X && f.parentNode.parentNode === t && !f.parentNode._isSplit) && (_.push(f), f._x -= w, R(f, t, V) && (f._wordEnd = !0)), "BR" === f.nodeName && f.nextSibling && "BR" === f.nextSibling.nodeName && I.push([])));
            for (a = 0; l > a; a++)
                f = g[a], p = f.parentNode === t, "BR" !== f.nodeName ? (j && (C = f.style, X || p || (f._x += f.parentNode._x, f._y += f.parentNode._y), C.left = f._x + "px", C.top = f._y + "px", C.position = "absolute", C.display = "block", C.width = f._w + 1 + "px", C.height = f._h + "px"), !X && B ? f._isSplit ? (f._next = f.nextSibling, f.parentNode.appendChild(f)) : f.parentNode._isSplit ? (f._parent = f.parentNode, !f.previousSibling && f.firstChild && (f.firstChild._isFirst = !0), f.nextSibling && " " === f.nextSibling.textContent && !f.nextSibling.nextSibling && Q.push(f.nextSibling), f._next = f.nextSibling && f.nextSibling._isFirst ? null : f.nextSibling, f.parentNode.removeChild(f), g.splice(a--, 1), l--) : p || (y = !f.nextSibling && R(f.parentNode, t, V), f.parentNode._parent && f.parentNode._parent.appendChild(f), y && f.parentNode.appendChild(c.createTextNode(" ")), e.span && (f.style.display = "inline"), O.push(f)) : f.parentNode._isSplit && !f._isSplit && "" !== f.innerHTML ? H.push(f) : B && !f._isSplit && (e.span && (f.style.display = "inline"), O.push(f))) : I || j ? (f.parentNode && f.parentNode.removeChild(f), g.splice(a--, 1), l--) : X || t.appendChild(f);
            for (a = Q.length; --a > -1;)
                Q[a].parentNode.removeChild(Q[a]);
            if (I) {
                for (j && (v = c.createElement(z), t.appendChild(v), S = v.offsetWidth + "px", y = v.offsetParent === t ? 0 : t.offsetLeft, t.removeChild(v)), C = t.style.cssText, t.style.cssText = "display:none;"; t.firstChild;)
                    t.removeChild(t.firstChild);
                for (m = " " === V && (!j || !X && !B), a = 0; a < I.length; a++) {
                    for (_ = I[a], v = c.createElement(z), v.style.cssText = "display:block;text-align:" + E + ";position:" + (j ? "absolute;" : "relative;"), F && (v.className = F + (Y ? a + 1 : "")), q.push(v), l = _.length, h = 0; l > h; h++)
                        "BR" !== _[h].nodeName && (f = _[h], v.appendChild(f), m && f._wordEnd && v.appendChild(c.createTextNode(" ")), j && (0 === h && (v.style.top = f._y + "px", v.style.left = w + y + "px"), f.style.top = "0px", y && (f.style.left = f._x - y + "px")));
        ...
        H = function(t, e, i, n) {
            ...
            for (L.insertBefore(R, t), R.textContent = t.nodeValue, L.removeChild(t), t = R, r = l(t), f = -1 !== r.indexOf("<"), e.reduceWhiteSpace !== !1 && (r = r.replace(m, " ").replace(_, "")), f && (r = r.split("<").join("{{LT}}")), h = r.length, o = (" " === r.charAt(0) ? T : "") + i(), s = 0; h > s; s++)
                if (d = r.charAt(s), d === k && r.charAt(s - 1) !== k && s) {
                    for (o += E ? N : "", E = !1; r.charAt(s + 1) === k;)
                        o += T, s++;
                    s === h - 1 ? o += T : ")" !== r.charAt(s + 1) && (o += T + i(), E = !0)
                } else
                    "{" === d && "{{LT}}" === r.substr(s, 6) ? (o += A ? n() + "{{LT}}</" + p + ">" : "{{LT}}", s += 5) : d.charCodeAt(0) >= C && d.charCodeAt(0) <= v || r.charCodeAt(s + 1) >= 65024 && r.charCodeAt(s + 1) <= 65039 ? (u = M(r.substr(s, 2)), g = M(r.substr(s + 2, 2)), a = (y > u || u > b || y > g || g > b) && (w > g || g > x) ? 2 : 4, o += A && " " !== d ? n() + r.substr(s, a) + "</" + p + ">" : r.substr(s, a), s += a - 1) : o += A && " " !== d ? n() + d + "</" + p + ">" : d;
        ...
        q = function(t, e, i, n) {
            ...
            if (3 !== t.nodeType || a > 1) {
                for (e.absolute = !1, r = 0; a > r; r++)
                    o = s[r], (3 !== o.nodeType || /\S+/.test(o.nodeValue)) && (h && 3 !== o.nodeType && "inline" === u(o, "display", null, !0) && (o.style.display = "inline-block", o.style.position = "relative"), o._isSplit = !0, q(o, e, i, n));
    ...
    V.split = function(t) {
        ...
        for (var e, i, n, r = this.elements.length, o = t.span ? "span" : "div", s = ("absolute" === t.position || t.absolute === !0, k(t.wordsClass, o)), a = k(t.charsClass, o); --r > -1;)
            n = this.elements[r], this._originals[r] = n.innerHTML, e = n.clientHeight, i = n.clientWidth, q(n, t, s, a), O(n, t, this.chars, this.words, this.lines, i, e);
